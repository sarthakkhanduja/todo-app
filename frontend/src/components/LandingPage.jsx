...
// function Navbar() {
//     return (
//         <div className="w-full h-24 flex justify-between items-center px-4 py-2 md:px-8">
...
//             <img className="w-full" src={heroImg} alt="heroImage" />
//         </div>
//     );
// }
...
// function Hero() {
//     return (
//         <div className="w-full flex flex-col px-8 md:w-1/2 md:px-0 md:pt-24 lg:px-16">
//             <div className="heading">
//                 <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Bring together all your tasks under one roof.</h2>
//             </div>
//             <div className="text-lg md:text-xl font-semibold mb-8">Struggling to organize tasks for different projects?<br /><span className="text-blue-marguerite-500 text-bold">Consolidate all your tasks in one place and track progress effortlessly.</span></div>
