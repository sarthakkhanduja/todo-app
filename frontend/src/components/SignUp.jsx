...
export default function SignUp() {
    ...
    return(
        <div className="min-h-screen w-full flex flex-col justify-center items-center">
            ...
            <BgImage />
            <div className="lg:grid lg:grid-cols-2 flex flex-col bg-white w-4/5 lg:w-2/3 h-4/5 rounded-2xl shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] z-10">
                <div className="px-5 lg:px-9 py-5 lg:py-9">
                    <div className="flex flex-col lg:flex-row px-5">
                        <p className='text-xs lg:pb-5 lg:pt-4 lg:pr-1'>Already have an account?</p>
                        <a className='text-xs underline decoration-{sky-500} text-sky-500 lg:pl-1 lg:pb-5 lg:pt-4 lg:pr-1 cursor-pointer' onClick={navigateToSignIn}>Sign in</a>
                    </div>
                    <div className="lg:text-4xl text-3xl font-bold text-gray-900 py-8 px-5">
                        <p>Sign Up 📝</p>
                    </div>
                    <div className="lg:grid lg:grid-cols-2 lg:gap-1 flex flex-col">
                        <Field label="Name" givenType="text" val={name} setFn={setName} validateFn={validateName} error={nameError} setError={setNameError} />
                        <Field label="Email" givenType="text" val={email} setFn={setEmail} validateFn={validateEmail} error={emailError} setError={setEmailError} />
                    </div>
                    <Field label="Password" givenType="password" val={pwd} setFn={setPwd} validateFn={validatePassword} error={pwdError} setError={setPwdError} />
